...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16995 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16995 = (function (val,box,meta16996){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16995.cljs$lang$type = true;
cljs.core.async.impl.channels.t16995.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16995";
cljs.core.async.impl.channels.t16995.cljs$lang$ctorPrWriter = (function (this__8436__auto__,writer__8437__auto__,opt__8438__auto__){return cljs.core._write.call(null,writer__8437__auto__,"cljs.core.async.impl.channels/t16995");
});
cljs.core.async.impl.channels.t16995.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16995.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16997){var self__ = this;
var _16997__$1 = this;return self__.meta16996;
});
cljs.core.async.impl.channels.t16995.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16997,meta16996__$1){var self__ = this;
var _16997__$1 = this;return (new cljs.core.async.impl.channels.t16995(self__.val,self__.box,meta16996__$1));
});
cljs.core.async.impl.channels.__GT_t16995 = (function __GT_t16995(val__$1,box__$1,meta16996){return (new cljs.core.async.impl.channels.t16995(val__$1,box__$1,meta16996));
});
}
return (new cljs.core.async.impl.channels.t16995(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_16998 = self__.takes.pop();if((taker_16998 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16998))
{var take_cb_16999 = cljs.core.async.impl.protocols.commit.call(null,taker_16998);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16999,taker_16998,this$__$1){
return (function (){return take_cb_16999.call(null,null);
});})(take_cb_16999,taker_16998,this$__$1))
);
} else
{}
{

...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16989 = 0;while(true){
var m_16990 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16990 == null))
{} else
{m_16990.call(null);
if((count_16989 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16991 = (count_16989 + 1);
count_16989 = G__16991;
continue;
}
} else
{}

...
{{
var G__14251 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14251;
continue;
}
} else
...
{var pred__14255 = cljs.core._EQ_;var expr__14256 = limit;if(cljs.core.truth_(pred__14255.call(null,1,expr__14256)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14255.call(null,2,expr__14256)))
...
{var ch = s.charAt(index);var temp__4124__auto___14262 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___14262))
{var replacement_14263 = temp__4124__auto___14262;buffer.append([cljs.core.str(replacement_14263)].join(''));
} else
{buffer.append(ch);
}
{
